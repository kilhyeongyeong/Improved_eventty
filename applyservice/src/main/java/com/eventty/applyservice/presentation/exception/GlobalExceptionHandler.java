package com.eventty.applyservice.presentation.exception;

import com.eventty.applyservice.domain.exception.ApplyException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponseDTO handleApplyException(ApplyException e) {
        log.error("ApplyException occurred : {}", e.getErrorCode().getMessage());
